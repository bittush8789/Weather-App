...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=89b1e1dbf986c7d6f5fa2eab53bf53c6'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyBeabfTNfCV1gdAu5Cpk4gG_ddwLdmPAbs'

    SEARCH_ENGINE_ID = 'f316f7d3e270c44bd'
